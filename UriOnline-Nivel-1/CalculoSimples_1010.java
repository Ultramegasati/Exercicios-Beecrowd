...
o número de peças 1, o valor unitário de cada
peça 1, o código de uma peça 2, o número de peças 2
...
os dois pontos e um espaço após o "R$". O valor
...
public class CalculoSimples_1010 {
    public static void main(String [] args){
        ...
        int codpc1 = entrada.nextInt();
        int qtpc1 = entrada.nextInt();
        double precopc1 = entrada.nextDouble();
        int codpc2 = entrada.nextInt();
        int qtpc2 = entrada.nextInt();
        double precopc2 = entrada.nextDouble();
        double calculo = ((qtpc1 * precopc1) +(qtpc2 * precopc2));
