...
de uma esfera sendo fornecido o valor de
seu raio (R). A fórmula para calcular o volume
é: (4/3) * pi * R3. Considere (atribua) para pi
o valor 3.14159.

Dica: Ao utilizar a fórmula, procure usar
(4/3.0) ou (4.0/3), pois algumas linguagens
(dentre elas o C++), assumem que o resultado da
...
public class Esfera_1011 {
        public static void main(String[] args){
            ...
            double total = ((4.0/3) * 3.14159 * Math.pow(volume,3));//ou (volume*volume*volume)
